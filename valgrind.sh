...
gcc -Wall -Wextra -pedantic -std=c99 -g -O2 test_suite.c -L. -lharbol -o harbol_test_program -ldl -Wl,--export-dynamic
valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes -v ./harbol_test_program
